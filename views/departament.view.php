...
<head>
	...
	<link rel="stylesheet" href="public/css/departament.css">
</head>
...
<body>
		...
		<div class="ContentBody">
			<header class="ContentHeader">
				...
				<div class="SeccionItems">
					<h2 class="Title">Archivo de Categorias</h2>
			...
			<div class="CustomerContent">
				...
				<?php include('modulos/__files/table_departament.php') ?>


				<?php include('modulos/__files/form_departament.php') ?>
	...
	<script src="public/js/departament.js"></script>
