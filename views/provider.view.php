...
<body>
		...
		<div class="ContentBody">
			<header class="ContentHeader">
				...
				<div class="SeccionItems">
					<h2 class="Title">Archivo de Proveedores</h2>
			...
			<div class="CustomerContent">
				...
				<?php include('modulos/__files/table_provider.php'); ?>


				<?php include('modulos/__files/form_provider.php'); ?>
	...
	<script src="public/js/provider.js"></script>
