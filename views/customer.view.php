...
<body>
		...
		<div class="ContentBody">
			<header class="ContentHeader">
				...
				<div class="SeccionItems">
					<h2 class="Title">Archivo de Clientes</h2>
			...
			<div class="CustomerContent">
				...
				<?php include('modulos/__files/table_customer.php') ?>


				<?php include('modulos/__files/form_customer.php') ?>
	...
	<div class="jlalert">
		<h1 class="TitleAlert" id="title_alert">
			Hola Mundo
		</h1>
