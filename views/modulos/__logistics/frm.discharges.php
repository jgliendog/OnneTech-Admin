<section class="FrmOperation">
    ...
    <header class="HeaderOperation">
        ...
        <h1 class="TitleOpartion"><span>Descargos de Inventario</span></h1>
    </header>
    ...
    <section class="TotalsOperation">
        <section class="BordeTotales">
            <div class="FrmInputTotales">
                <label for="numbers_dicharges">Número:</label>
                <input readonly type="text" class="NumDocumento NumInputRight" id="numbers_dicharges" value="00000001" name="NumDocumento">
            </div>
            <div class="FrmInputTotales">
                <label for="FechaCompras">Fecha:</label>
                <input type="text" class="FechaCompras NumInputRight" id="date_discharges" value="19/08/2019" name="FechaCompras">
            </div>
