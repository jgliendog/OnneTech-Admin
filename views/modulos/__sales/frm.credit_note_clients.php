<section class="FrmOperation">
    ...
    <header class="HeaderOperation">
        ...
        <h1 class="TitleOpartion"><span>Nota de Crédito Cliente</span></h1>
    </header>
    ...
    <section class="TotalsOperation">
        <section class="BordeTotales">
            <label for="FechaCompras">Número:</label>
                <input type="text" class="FechaCompras NumInputRight" id="number_credit_note_clients" value="19/08/2019" name="NumberCreditNoteClients">
            </div>
            <div class="FrmInputTotales">
                <label for="FechaCompras">Fecha:</label>
                <input type="text" class="FechaCompras NumInputRight" id="date_credit_note_clients" value="19/08/2019" name="FechaCompras">
            </div>
            <div class="FrmInputTotales">
                <label for="FechaCompras">Total Bruto:</label>
                <input readonly type="text" class="FechaCompras NumInputRight" id="credit_note_clients" value="0.00" name="FechaCompras">
            </div>
            <div class="FrmInputTotales">
            ...
            <div class="FrmInputTotales">
                ...
                <input type="text" class="FechaCompras NumInputRight" id="credit_note_clients" value="0.00" name="FechaCompras">
            </div>
            <div class="FrmInputTotales">
