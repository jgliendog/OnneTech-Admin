<section class="FrmOperation">
    ...
    <header class="HeaderOperation">
        ...
        <h1 class="TitleOpartion"><span>Presupuesto</span></h1>
    </header>

    <div class="DataOperation">

            <div class="InputGroup">
            <label class="LabelInput" for="InputItems">Cliente</label>
    ...
    <section class="TotalsOperation">
        <section class="BordeTotales">
            <div class="FrmInputTotales">
                <label for="number_budget">Número:</label>
                <input type="text" class="NumInputRight" id="number_budget" value="00000001" name="NumBudget">
            </div>
            <div class="FrmInputTotales">
                <label for="date_budget">Fecha:</label>
                <input type="text" class="NumInputRight" id="date_budget" value="19/08/2019" name="DateBudget">
            </div>
            <div class="FrmInputTotales">
                <label for="total_amount_budget">Total Bruto:</label>
                <input readonly type="text" class="NumInputRight" id="total_amount_budget" value="0.00" name="TotalAmountBudget">
            </div>
            <div class="FrmInputTotales">
                <label for="discount_budget">Descuento:</label>
                <input readonly type="text" class="NumInputRight" id="discount_budget" value="0.00" name="DiscountBudget">
            </div>
            <div class="FrmInputTotales">
                <label for="base_tax_budget">Base Imponible:</label>
                <input type="text" class="NumInputRight" id="base_tax_budget" value="0.00" name="BaseTaxBudget">
            </div>
            <div class="FrmInputTotales">
                <label for="tax_budget">IGV - 18%:</label>
                <input readonly type="text" class="NumInputRight" id="tax_budget" value="0.00" name="TaxBudget">
            </div>
            <div class="FrmInputTotales">
                <label for="total_net_amount_budget">Total Compras:</label>
                <input readonly type="text" class="NumInputRight" id="total_net_amount_budget" value="0.00" name="TotalNetAmountBudget">
            </div>
        </section>
    </section>
