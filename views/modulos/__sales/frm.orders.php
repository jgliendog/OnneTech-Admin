<section class="FrmOperation">
    ...
    <header class="HeaderOperation">
        ...
        <h1 class="TitleOpartion"><span>Pedidos</span></h1>
    </header>
    ...
    <section class="TotalsOperation">
        <section class="BordeTotales">
            <div class="FrmInputTotales">
                ...
                <input type="text" class="FechaCompras NumInputRight" id="number_orders" value="19/08/2019" name="FechaCompras">
            </div>
            <div class="FrmInputTotales">
                <label for="FechaCompras">Total Bruto:</label>
                <input readonly type="text" class="FechaCompras NumInputRight" id="total_orders" value="0.00" name="FechaCompras">
            </div>
            <div class="FrmInputTotales">
                <label for="FechaCompras">Descuento:</label>
                <input readonly type="text" class="FechaCompras NumInputRight" id="discount_orders" value="0.00" name="FechaCompras">
            </div>
            <div class="FrmInputTotales">
                <label for="FechaCompras">Base Imponible:</label>
                <input type="text" class="FechaCompras NumInputRight" id="base_orders" value="0.00" name="FechaCompras">
            </div>
            <div class="FrmInputTotales">
                <label for="FechaCompras">IGV - 18%:</label>
                <input readonly type="text" class="FechaCompras NumInputRight" id="tax_orders" value="0.00" name="FechaCompras">
            </div>
            <div class="FrmInputTotales">
                <label for="FechaCompras">Total Compras:</label>
                <input readonly type="text" class="FechaCompras NumInputRight" id="total_net_orders" value="0.00" name="FechaCompras">
            </div>
        </section>
    </section>
