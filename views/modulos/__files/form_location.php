<form action="#" class="ContentForm" id="content_form">
	...
	<section class="FormContentFirst" id="FormContentFirst">
		...
		<div class="InputGroup InputCode">
			...
			<input hidden id="location_id" class="InputItems" type="text">
			<input id="location_code" class="InputItems" type="text">
		</div>

		<div class="InputGroup InputDescription">
			<label class="LabelInput" for="InputItems">Descripción</label>
			<input id="location_description" class="InputItems" type="text" name="DescriptionLocation">
		</div>
		...
		<div class="InputGroup InputDetail">
			...
			<textarea id="location_detail" name="DetailLocation" class="InputItems InputText"></textarea>
		</div>

		<div class="InputGroup InputDate">
			<label class="LabelInput" for="InputItems">Fecha</label>
			<input id="location_date" class="InputItems" type="date">
		</div>

		<div class="InputGroup InputStatus">
			<label class="LabelInput" for="InputItems">status </label>
			<input id="location_status" class="InputCheck" type="checkbox" name="StatusLocation">
		</div>
	</section>
