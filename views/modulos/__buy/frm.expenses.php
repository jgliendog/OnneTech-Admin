<section class="FrmOperation">
    <header class="HeaderOperation">
        ...
        <h1 class="TitleOpartion"><span>Gastos</span></h1>
    </header>
    ...
    <div class="DataOperation">
        ...
        <section class="InputGroup SelectItems">
            ...
            <a href="#" class="BtnAction OutLoad BtnSizeXs"><span><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Agregar</span></a>
        </section>
    </div>
    ...
    <section class="TotalsOperation">
        <section class="BordeTotales">
            <div class="FrmInputTotales">
                ...
                <input type="text" class="FechaCompras NumInputRight" id="numbers_expenses" value="00000001" name="FechaCompras">
            </div>
            <div class="FrmInputTotales">
                <label for="FechaCompras">Fecha:</label>
                <input type="text" class="FechaCompras NumInputRight" id="date_expenses" value="19/08/2019" name="FechaCompras">
            </div>
            <div class="FrmInputTotales">
                <label for="FechaCompras">Total Bruto:</label>
                <input readonly type="text" class="FechaCompras NumInputRight" id="total_amount_expenses" value="0.00" name="FechaCompras">
            </div>
            <div class="FrmInputTotales">
                <label for="FechaCompras">Descuento:</label>
                <input readonly type="text" class="FechaCompras NumInputRight" id="discounts_expenses" value="0.00" name="FechaCompras">
            </div>
            <div class="FrmInputTotales">
                <label for="FechaCompras">Base Imponible:</label>
                <input type="text" class="FechaCompras NumInputRight" id="base_amount_tax_expenses" value="0.00" name="FechaCompras">
            </div>
            <div class="FrmInputTotales">
                <label for="FechaCompras">IGV - 18%:</label>
                <input readonly type="text" class="FechaCompras NumInputRight" id="amount_tax_expenses" value="0.00" name="FechaCompras">
            </div>
            <div class="FrmInputTotales">
                <label for="FechaCompras">Total Compras:</label>
                <input readonly type="text" class="FechaCompras NumInputRight" id="total_amount" value="0.00" name="FechaCompras">
            </div>
        </section>
    </section>
