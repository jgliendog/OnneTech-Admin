<section class="FrmOperation">
    ...
    <header class="HeaderOperation">
       ...
       <a href="#" class="BtnNavBar" id="btn_nav_bar">
        ...
        <h1 class="TitleOpartion"><span>Compra de Mercancia</span></h1>
    </header>
    ...
    <section class="TotalsOperation">
        <section class="BordeTotales">
            <div class="FrmInputTotales">
                <label for="FechaCodate_buympras">Fecha:</label>
                <input type="text" class="FechaCompras NumInputRight" id="date_buy" value="19/08/2019" name="FechaCompras">
            </div>
            <div class="FrmInputTotales">
                <label for="total_full">Total Bruto:</label>
                <input readonly type="text" class="FechaCompras NumInputRight" id="total_full" value="0.00" name="FechaCompras">
            </div>
            <div class="FrmInputTotales">
                <label for="save">Descuento:</label>
                <input readonly type="text" class="FechaCompras NumInputRight" id="save" value="0.00" name="FechaCompras">
            </div>
            <div class="FrmInputTotales">
                <label for="impo_tax">Base Imponible:</label>
                <input type="text" class="FechaCompras NumInputRight" id="impo_tax" value="0.00" name="FechaCompras">
            </div>
            <div class="FrmInputTotales">
                <label for="tax">IGV - 18%:</label>
                <input readonly type="text" class="FechaCompras NumInputRight" id="tax" value="0.00" name="FechaCompras">
            </div>
            <div class="FrmInputTotales">
                <label for="total_buy">Total Compras:</label>
                <input readonly type="text" class="FechaCompras NumInputRight" id="total_buy" value="0.00" name="FechaCompras">
            </div>
        </section>
    </section>
