...
$Vista = $ListTable->ListResultFile($conexion,'flocation',ItemsPager);
$row = count($Vista);
...
// echo "comienza ".$stard;
	$PagerResult = $ListTable->PagerResult($conexion,'flocation','FL_ID',$stard,ItemsPager);



include('views/location.view.php');